...
/*   Updated: 2024/11/09 02:02:31 by codespace        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    MateriaSource::learnMateria(AMateria *m)
{
	...
	for (int i = 0; i < SIZE; i++)
	{
		...
		{
			this->_materia[i] = m;
			std::cout << "MateriaSource learnMateria called with: "<< m->getType() << std::endl;
            return ;
		}
	}
	std::cout << "MateriaSource object is full, can't add " << m->getType << std::endl;
    delete m;
}
